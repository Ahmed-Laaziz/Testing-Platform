...
import EditCi from '../../components/edit-element/edit_ci';  // Import the table
...
export default function Home() {
  ...
  return (
    <div>
      {isTokenValid ? (
        <DashboardLayoutBasic component={EditCi} />  // Pass the table component when rendering the dashboard
      ) : showErrorPage ? (
        <ErrorPage />
      ) : (
        <></>
