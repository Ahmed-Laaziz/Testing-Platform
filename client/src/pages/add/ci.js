...
import AddCi from '../../components/add-element/add_ci';  // Import the table
...
export default function Home() {
  ...
  return (
    <div>
      {isTokenValid ? (
        <DashboardLayoutBasic component={AddCi} />  // Pass the table component when rendering the dashboard
      ) : showErrorPage ? (
        <ErrorPage />
      ) : (
