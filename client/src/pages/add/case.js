...
import AddCase from '../../components/add-element/add_case';  // Import the table
...
export default function Home() {
  ...
  return (
    <div>
      {isTokenValid ? (
        <DashboardLayoutBasic component={AddCase} />  // Pass the table component when rendering the dashboard
      ) : showErrorPage ? (
        <ErrorPage />
      ) : (
