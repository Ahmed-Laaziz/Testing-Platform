...
export default function DataTable() {
  ...
  const handleUpdateClick = (subFunctionality) => {
    navigate('/edit-subFunctionality', { state: { subFunctionalityId: subFunctionality._id } }); // Pass subFunctionality ID via state
};
  ...
  function CustomToolbar() {
    return (
      <GridToolbarContainer>
        ...
        <Button variant="outlined" size="small" startIcon={<AddIcon />} onClick={() => navigate('/add-subFunctionality')} >
