...
export default function DataTable() {
  ...
  const handleUpdateClick = (functionality) => {
    navigate('/edit-functionality', { state: { functionalityId: functionality._id } }); // Pass functionality ID via state
};
  ...
  function CustomToolbar() {
    return (
      <GridToolbarContainer>
        ...
        <Button variant="outlined" size="small" startIcon={<AddIcon />} onClick={() => navigate('/add-functionality')} >
          Add Functionality
        </Button>
        <GridToolbarExport
          slotProps={{
